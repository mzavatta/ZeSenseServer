...
LOCAL_SRC_FILES := ze_sm_resbuf.c ze_coap_resources.c ze_coap_server_core.c ze_rtp_server_core.c ze_coap_server_root.c ze_sm_reqbuf.c ze_streaming_manager.c
